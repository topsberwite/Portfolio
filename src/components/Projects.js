    ...
    <div className="projects">
      ...
      <Reveal>
        <div className="projects-container">
          ...
          <div className="project">
            <img src="/images/thumbnails/blog-api.png" alt="blog-website"></img>
            <div className="project-description">
              <h2>Blog API</h2>
          ...
          <div className="project">
            <img src="/images/thumbnails/simon-game.png" alt="simon-game"></img>
            <div className="project-description">
              <h2>Simon Game</h2>
              <p>
                A memory game of lights and sounds in which players must repeat
                random sequences of flashing lights by pressing the colored pads
